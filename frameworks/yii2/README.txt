...
public function actionForm()
{
    ...
    //Проверяем, можео ли загрузить данный в объект формы.
    //Если поле не указано в методе rules, то значение для него не попадет в модель
    //Либо полу бд не будет обновлено либо заполнено
    //Поэтому минимум нужно добавить валидатор safe ['fieldname', 'safe'] или trim
    if(
